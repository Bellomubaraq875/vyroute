...
const Hero = (props: Props) => {
  ...
  const [returnTripform, setreturnTripform] = useState({
    from: "",
    to: "",
    departureDate: bookingformtwo.departuredate,
    adults: 1,
  });
        ...
        <div className="flex gap-3 ">
          <div className="flex flex-col">
            ...
            <select
              name="date"
              className="w-full"
              value={returnTripform.departureDate}
              onChange={handleSelectChange}>
              <option
                className=""
                value={bookingformtwo.departuredate}
                disabled
                hidden>
                {bookingformtwo.departuredate}
              </option>
              <option value="2024-03-05">2024-03-10</option>
            </select>
          </div>
          <div className="flex flex-col">
            ...
            <select
              ...
              <option
                className=""
                value={bookingformtwo.returndate}
                disabled
                hidden>
                {bookingformtwo.returndate}
              </option>
              <option value="2024-03-05">2024-03-10</option>
            </select>
          </div>
